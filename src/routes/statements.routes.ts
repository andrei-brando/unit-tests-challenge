...
import { TransferBetweenAccountsController } from "../modules/statements/useCases/transferBetweenAccounts/TransferBetweenAccountController";
...
statementRouter.post(
  "/transfers/:user_id",
  transferBetweenAccountsController.handle
);
